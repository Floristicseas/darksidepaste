...
public:
	...
	SCHEMA(m_last_movement_impulses, vec3_t, "CPlayer_MovementServices", "m_vecLastMovementImpulses");
...
public:
	...
	SCHEMA(m_max_speed, firing_float_t, "CCSWeaponBaseVData", "m_flMaxSpeed");
};
...
public:
	...
	bool IsEnemy(c_cs_player_pawn* pOther)
	{
...
public:
	...
	SCHEMA(m_glowColorOverride, c_color, "CGlowProperty", "m_glowColorOverride");
	
	c_cs_player_pawn* m_pOwner;
};
