...
public:
	...
	void(__cdecl* fnUtlBufferInit)(CUtlBuffer*, int, int, int) = nullptr;
	void(__cdecl* fnUtlBufferPutString)(CUtlBuffer*, const char*) = nullptr;
	void(__cdecl* fnUtlBufferEnsureCapacity)(CUtlBuffer*, int) = nullptr;

	std::int64_t(__fastcall* fnCreateMaterial)(void*, void*, const char*, void*, unsigned int, unsigned int) = nullptr;
